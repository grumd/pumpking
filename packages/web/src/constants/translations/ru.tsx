...
export const ru = {
  ...
  SIGN_UP_WITH_DISCORD: 'Регистрация через Discord',
  CREATE_NEW_ACCOUNT: 'Создать новый аккаунт',
  ALREADY_HAVE_ACCOUNT: 'Уже есть аккаунт? Войти',
  VERIFYING_DISCORD: 'Проверка аккаунта Discord...',
  SIGNING_IN_DISCORD: 'Вход через Discord...',
  NO_DISCORD_CODE: 'Код авторизации от Discord не получен',
  BACK_TO_REGISTRATION: 'Назад к регистрации',
  BACK_TO_LOGIN: 'Назад к логину',
  CREATE_YOUR_ACCOUNT: 'Создайте свой аккаунт',
  EMAIL_LABEL: 'Email:',
  NICKNAME: 'Никнейм',
  NICKNAME_PLACEHOLDER: 'Ваш никнейм',
  REGION_SELECT_PLACEHOLDER: 'Выберите страну',
  ARCADE_NAME_LABEL: 'Имя в аркаде (необязательно)',
  ARCADE_NAME_PLACEHOLDER: 'Ваше имя в AMPASS',
  REGISTER: 'Зарегистрироваться',
  VALIDATION_SELECT_COUNTRY: 'Пожалуйста, выберите страну',
