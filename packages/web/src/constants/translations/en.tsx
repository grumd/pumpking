export const en = {
  ...
  */
  ...
  // Add Result / OCR
  SUBMIT_RESULT: 'Submit a result',
  CHART: 'Chart',
  SCREENSHOT: 'Screenshot',
  SELECT_SCREENSHOT: 'Select screenshot',
  HEIC_NOT_SUPPORTED: 'HEIC files are not supported. Please convert your screenshot to JPG or PNG.',
  GRADE: 'Grade',
  SELECT_GRADE: 'Select a grade',
  MIX: 'Mix',
  JUDGE_RANK: 'Judge/rank',
  SUBMIT: 'Submit',
  NO_ACCESS_TO_PAGE: "You don't have access to this page",
  NONE_NORMAL_MODE: 'None (normal mode)',
  FALSE_RESULTS_WARNING:
    'Submitting false results may result in a BAN. Make sure your screenshot is readable and the numbers you selected are correct.',
  SCREENSHOT_REQUIRED: 'Screenshot is required',
  GRADE_REQUIRED: 'Grade is required',
  PERFECT_REQUIRED: 'Perfect is required',
  GREAT_REQUIRED: 'Great is required',
  GOOD_REQUIRED: 'Good is required',
  BAD_REQUIRED: 'Bad is required',
  MISS_REQUIRED: 'Miss is required',
  COMBO_REQUIRED: 'Combo is required',
  SCORE_REQUIRED_MIN_DIGITS: 'Score is required (min 4 digits)',
  DATE_TAKEN: 'Date taken',
  UNKNOWN: 'Unknown',
  OCR_DRAW_RECTANGLE_HINT: 'Draw a rectangle around the score numbers to recognize them',
  OCR_AREA_SELECTED_HINT: 'Area selected. Click "Recognize score" to extract numbers.',
  RECOGNIZE_SCORE: 'Recognize score',
  RECOGNIZED_NUMBERS: 'Recognized numbers',
  FILL_FORM: 'Fill form',
